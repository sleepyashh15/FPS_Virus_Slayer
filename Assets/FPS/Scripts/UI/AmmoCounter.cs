...
namespace Unity.FPS.UI
{
    ...
    public class AmmoCounter : MonoBehaviour
    {
        ...
        public Vector3 UnselectedScale = new Vector3(2,2,2) * 0.8f;
        ...
        void Update()
        {
            ...
            CanvasGroup.alpha = Mathf.Lerp(CanvasGroup.alpha, isActiveWeapon ? 1f : UnselectedOpacity,
                Time.deltaTime * 10);
            transform.localScale = Vector3.Lerp(transform.localScale, isActiveWeapon ? new Vector3(2,2,2) : UnselectedScale,
                Time.deltaTime * 10);
