...
namespace Unity.FPS.Gameplay
{
    ...
    public class PlayerInputHandler : MonoBehaviour
    {
        ...
        void Start()
        {
          ...
          Cursor.lockState = CursorLockMode.Confined;
           ...
           // _input = GetComponent<HumanoidLandInput>();
            DebugUtility.HandleErrorIfNullFindObject<HumanoidLandInput, PlayerInputHandler>(_input, this);
        ...
        public float GetLookInputsVertical()
        {
            ...
            return SimpleInput.GetAxis("LookY");
        }
        ...
        public int GetSwitchWeaponInput()
        {
            if (CanProcessInput())
            {
                ...
                if (_input.ScrollIsPressed < 0f)
                    return -1;
                else if (_input.ScrollIsPressed > 0f)
                    return 1;
                else if (_input.ScrollIsPressed < 0f)
                    return -1;
                else if (_input.ScrollIsPressed > 0f)
